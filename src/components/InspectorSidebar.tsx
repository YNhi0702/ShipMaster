...
const InspectorSidebar: React.FC<InspectorSidebarProps> = ({ selectedKey, onSelect, collapsed = false, onCollapse }) => {
    ...
    return (
        <Sider width={220} collapsible collapsed={collapsed} onCollapse={onCollapse} trigger={null} className="bg-white shadow-md min-h-screen">
            <div className="h-16 flex items-center justify-center text-2xl font-bold border-b select-none cursor-pointer" onClick={() => navigate('/inspector')}>
                {!collapsed ? (
